...
namespace BitacoraDireccionesIp
{
    public class ExcelResult : ActionResult
    {
        private DbContext _dataContext;
         ...
         public ExcelResult(DbContext dataContext, IQueryable rows, string fileName)
             : this(dataContext, rows, fileName, null, null, null, null)
         {
         }

         public ExcelResult(DbContext dataContext, IQueryable rows, string fileName, string[] headers)
